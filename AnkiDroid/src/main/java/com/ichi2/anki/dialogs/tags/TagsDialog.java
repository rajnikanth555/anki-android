...
public class TagsDialog extends AnalyticsDialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<String> checkedTags = requireArguments().getStringArrayList(CHECKED_TAGS_KEY);
        List<String> allTags = requireArguments().getStringArrayList(ALL_TAGS_KEY);

        mTagList = new TagsList(allTags, checkedTags);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mTagsArrayAdapter = new TagsArrayAdapter(mTagList);
        ...
        MaterialDialog.Builder builder = new MaterialDialog.Builder(requireActivity())
                ...
                .onPositive((dialog, which) -> ((TagsDialogListener)requireActivity())
                        .onSelectedTags(mTagList.getCheckedTagList(), mSelectedOption));
    ...
    private void adjustToolbar(View tagsDialogView) {
        ...
        checkAllItem.setOnMenuItemClickListener(menuItem -> {
            if (mTagList.toggleAllCheckedStatuses()) {
